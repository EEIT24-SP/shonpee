...
public class ProductController {
    ...
    public String bearitem(@PathVariable("productid") Integer productid, Model model ) {
	 ...
	 if(productBeans.isPresent()) {
		 ...
		 //規格
		 PropertyBean propertybeanfirst = propertyRepository.findPropertyBeanByProdcutID(productid);
		 ...
		 PropertyBeanSecond propertyBeanSecond = propertySecondRepository.findPropertyBeanByProdcutID(productid);
